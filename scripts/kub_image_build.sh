...
# Pull the image
echo "#### Pulling Docker image $CD_DOCKER_USERNAME/nginx-kub"
#docker pull $CD_DOCKER_USERNAME/nginx-kub

# Build the image
echo "#### Docker image $CD_DOCKER_USERNAME/nginx-kub is being built"
docker build -t $CD_DOCKER_USERNAME/nginx-kub ./nginx/kubernetes

echo "#### Docker image $CD_DOCKER_USERNAME/nginx-kub is being published"
docker push $CD_DOCKER_USERNAME/nginx-kub
